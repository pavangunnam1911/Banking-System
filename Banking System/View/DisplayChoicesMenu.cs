namespace Bank
{
    public class DisplayChoices
    {
        ...
        public void holderSuccess()
        {
            Console.WriteLine("Holder Created Successfully!");
        }

        public void createStaff()
        {
            Console.WriteLine("Create staff account");
        }

        public void loginStaff()
        {
            Console.WriteLine("Login to your staff Account");
        }

        public void createHolder()
        {
            Console.WriteLine("Create Holder Account");
        }

        public void loginHolder()
        {
            Console.WriteLine("Login to your Holder Account");
        }

        public void usernameUpdate()
        {
            Console.WriteLine("Enter account username to update");
        }

        public void usernameDelete()
        {
            Console.WriteLine("Enter account username to delete");
        }
        ...
        public void currencyCodeEnter()
        {
            Console.WriteLine("Enter currency code");
        }

        public void AmountEnter()
        {
            Console.WriteLine("Enter amount");
        }

        public void TransactionIDEnter()
        {
        ...
        public void receiverUsernameEnter()
        {
